...
new_df = cell_count_file.melt(id_vars=['sample', 'total_population'], value_vars=cell_types,
                              var_name='cell_type', value_name='cell_population')

new_df['percentage'] = (new_df['cell_population'] / new_df['total_population']) * 100

# Reorder columns so they are like the given instructions
finalCSV = new_df[['sample', 'total_population', 'cell_type', 'cell_population', 'percentage']]
