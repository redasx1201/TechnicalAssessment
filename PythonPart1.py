...
cell_count_file['total_count'] = cell_count_file[cell_types].sum(axis=1)

# Change DataFrame to give each cell type their own row
new_df = cell_count_file.melt(id_vars=['sample', 'total_count'], value_vars=cell_types,
...
finalCSV = new_df[['sample', 'total_count', 'population', 'count', 'percentage']]
